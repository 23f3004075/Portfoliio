...
function renderHero() {
  ...
  const socialBtns = [
    CONFIG.social.github   && `<a href="${CONFIG.social.github}"   target="_blank" rel="noopener" class="btn btn-primary">${ICONS.github}   GitHub</a>`,
